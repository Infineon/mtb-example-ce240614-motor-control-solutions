...
#define MOTOR_CTRL_FAULT_PHASE_LOSS_MIN_CURRENT     (0.000f)                    /*[A],phase loss detection minimum current threshold*/
...
#define MOTOR_CTRL_STALL_CURRENT                   (MOTOR_CURRENT_PEAK)         /*[A], stall detection minimum current threshold*/
...
#define MOTOR_CTRL_VOLT_MOD_SCHEME                 (Space_Vector_Modulation)     /*Neutral_Point_Modulation =0,Space_Vector_Modulation =1; single-shunt phase-shift PWM requires SVM*/
